...
function loadScheduleCampus() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(".chosen-select5").val($("#Stype").val());
            $(".chosen-select5").trigger("chosen:updated");
            //点击事件
...
function loadConsultingCourse() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(".chosen-select6").append(html);
            $(".chosen-select6").chosen({
                maxHeight: 200
            });
            $(".chosen-select6").val($("#Etype").val());
            $(".chosen-select6").trigger("chosen:updated");
            //点击事件
            $('.chosen-select6').on('change', function (e, params) {
                $('#exampleTable').bootstrapTable('refresh', opt);
            });
        }
    });
